...
export default function Contact() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between pt-24">
      ...
      <p className="mt-[45px] font-bold text-[25px] flex items-center">
      GOT A QUESTION? REACH OUT TO US!
      </p>

      <div className="relative hover-trigger mt-6">
        <Link href="mailto:support@fastingfocused.com">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="inline-block pointer-events-none h-[60px] w-[60px] ml-2 text-[#CCCCCC]"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
